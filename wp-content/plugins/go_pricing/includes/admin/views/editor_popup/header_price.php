...
<table class="gwa-table" data-parent-id="type" data-parent-value="price-html"<?php echo empty( $postdata['type'] ) || ( !empty( $postdata['type'] ) && $postdata['type'] != 'price-html' ) ? ' style="display:none;"' : ''; ?>>
	<tr>
		<th><label><?php _e( 'Price Content', 'go_pricing_textdomain' ); ?> (<span class="gwa-info">USD</span>)</label></th>
		<td><div class="gwa-input-btn"><input type="text" name="price-html[content_0]" value="<?php echo isset( $postdata['price-html']['content_0'] ) ? esc_attr( $postdata['price-html']['content_0'] ) : ''; ?>" data-popup="sc-font-icon" data-preview="<?php _e( 'Price', 'go_pricing_textdomain' ); ?>"><a href="#"  data-action="popup" data-popup="sc-font-icon" title="<?php _e( 'Add Shortcode', 'go_pricing_textdomain' ); ?>"><i class="fa fa-code"></i></a></div></td>
		<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Price content.', 'go_pricing_textdomain' ); ?></p></td>
	</tr>
	<tr>
		<th><label><?php _e( 'Price Content', 'go_pricing_textdomain' ); ?> (<span class="gwa-info">EUR</span>)</label></th>
		<td><div class="gwa-input-btn"><input type="text" name="price-html[content_1]" value="<?php echo isset( $postdata['price-html']['content_1'] ) ? esc_attr( $postdata['price-html']['content_1'] ) : ''; ?>" data-popup="sc-font-icon" data-preview="<?php _e( 'Price', 'go_pricing_textdomain' ); ?>"><a href="#"  data-action="popup" data-popup="sc-font-icon" title="<?php _e( 'Add Shortcode', 'go_pricing_textdomain' ); ?>"><i class="fa fa-code"></i></a></div></td>
		<td class="gwa-abox-info"><p class="gwa-info"><i class="fa fa-info-circle"></i><?php _e( 'Price content.', 'go_pricing_textdomain' ); ?></p></td>
	</tr>
	<tr>
