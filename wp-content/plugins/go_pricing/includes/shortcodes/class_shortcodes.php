			...
			if ( !empty( $column_style_data['type'] ) ) {
				...
				switch( $column_style_data['type'] ) {	
					...
					case 'cpricing' :
						...
						if (function_exists('get_currency_by_geoip')){
							$ip_currency = get_currency_by_geoip();
						}else{
							$ip_currency = '';
						}
						...
						switch( $price_type ) {
							...
							case 'price-html' :
								if ($ip_currency == 'EUR'){
									$price = sprintf('<span>%s</span>', isset($col_data['price']['price-html']['content_1']) ? $col_data['price']['price-html']['content_1'] : '');
								}else {
									$price = sprintf('<span>%s</span>', isset($col_data['price']['price-html']['content_0']) ? $col_data['price']['price-html']['content_0'] : '');
								}
